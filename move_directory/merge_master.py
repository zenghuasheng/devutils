...
if __name__ == '__main__':
    files_path_map = [
        ...
        ("email_templates/add_related_tasks_html", "ones-project-api", "email_templates/add_related_tasks_html"),
        ("email_templates/batch_tasks_notice_html", "ones-project-api", "email_templates/batch_tasks_notice_html"),
        ("email_templates/batch_update_tasks_issue_notice_html", "ones-project-api",
         "email_templates/batch_update_tasks_issue_notice_html"),
        ("email_templates/cn/general_information/header_html", "ones-project-api",
         "email_templates/cn/general_information/header_html"),
        ("email_templates/cn/jira_migration/import_jira_fail_html", "ones-project-api",
         "email_templates/cn/jira_migration/import_jira_fail_html"),
        ("email_templates/cn/jira_migration/import_jira_success_html", "ones-project-api",
         "email_templates/cn/jira_migration/import_jira_success_html"),
        ("email_templates/cn/license_expired_html", "ones-project-api", "email_templates/cn/license_expired_html"),
        ("email_templates/cn/license_expiring_soon_html", "ones-project-api",
         "email_templates/cn/license_expiring_soon_html"),
        ("email_templates/cn/license_scale_changed_html", "ones-project-api",
         "email_templates/cn/license_scale_changed_html"),
        ("email_templates/cn/license_upgrade_html", "ones-project-api", "email_templates/cn/license_upgrade_html"),
        ("email_templates/com/change_password_html", "ones-project-api", "email_templates/com/change_password_html"),
        ("email_templates/com/free/com_free_upgrade_html", "ones-project-api",
         "email_templates/com/free/com_free_upgrade_html"),
        ("email_templates/com/free/com_free_welcome_html", "ones-project-api",
         "email_templates/com/free/com_free_welcome_html"),
        ("email_templates/com/general_information/footer_html", "ones-project-api",
         "email_templates/com/general_information/footer_html"),
        ("email_templates/com/general_information/header_html", "ones-project-api",
         "email_templates/com/general_information/header_html"),
        ("email_templates/com/jira_migration/import_jira_fail_html", "ones-project-api",
         "email_templates/com/jira_migration/import_jira_fail_html"),
        ("email_templates/com/jira_migration/import_jira_success_html", "ones-project-api",
         "email_templates/com/jira_migration/import_jira_success_html"),
        ("email_templates/com/trial/com_self_trial_expiration_html", "ones-project-api",
         "email_templates/com/trial/com_self_trial_expiration_html"),
        ("email_templates/com/trial/com_trial_expiration_html", "ones-project-api",
         "email_templates/com/trial/com_trial_expiration_html"),
        ("email_templates/com/trial/com_trial_feature_html", "ones-project-api",
         "email_templates/com/trial/com_trial_feature_html"),
        ("email_templates/com/trial/com_trial_questionnaire_html", "ones-project-api",
         "email_templates/com/trial/com_trial_questionnaire_html"),
        ("email_templates/com/trial/com_trial_welcome_html", "ones-project-api",
         "email_templates/com/trial/com_trial_welcome_html"),
        ("email_templates/copilot_embedding_result_html", "ones-project-api",
         "email_templates/copilot_embedding_result_html"),
        ("email_templates/free_org_expire_after_1_days_html", "ones-project-api",
         "email_templates/free_org_expire_after_1_days_html"),
        ("email_templates/free_org_expire_before_7_days_html", "ones-project-api",
         "email_templates/free_org_expire_before_7_days_html"),
        ("email_templates/general_information/header_html", "ones-project-api",
         "email_templates/general_information/header_html"),
        ("email_templates/import_jira_result_html", "ones-project-api", "email_templates/import_jira_result_html"),
        ("email_templates/invitation_free_html", "ones-project-api", "email_templates/invitation_free_html"),
        ("email_templates/invitation_html", "ones-project-api", "email_templates/invitation_html"),
        (
        "email_templates/license_expiring_soon_html", "ones-project-api", "email_templates/license_expiring_soon_html"),
        (
        "email_templates/license_scale_changed_html", "ones-project-api", "email_templates/license_scale_changed_html"),
        ("email_templates/license_upgrade_html", "ones-project-api", "email_templates/license_upgrade_html"),
        (
            "email_templates/password_expire_notice_html", "ones-project-api",
            "email_templates/password_expire_notice_html"),
        (
            "email_templates/related_objects_notice_html", "ones-project-api",
            "email_templates/related_objects_notice_html"),
        ("email_templates/request_create_team_code_html", "ones-project-api",
         "email_templates/request_create_team_code_html"),
        ("email_templates/reset_password_link_html", "ones-project-api", "email_templates/reset_password_link_html"),
        ("email_templates/single_operate_code_html", "ones-project-api", "email_templates/single_operate_code_html"),
        ("email_templates/sso_verify_html", "ones-project-api", "email_templates/sso_verify_html"),
        ("email_templates/task_activity_message/batch_merge_html", "ones-project-api",
         "email_templates/task_activity_message/batch_merge_html"),
        ("email_templates/task_comment_email_html", "ones-project-api", "email_templates/task_comment_email_html"),
        ("email_templates/task_deadline_email_html", "ones-project-api", "email_templates/task_deadline_email_html"),
        ("email_templates/task_notice_email_html", "ones-project-api", "email_templates/task_notice_email_html"),
        ("email_templates/task_update_email_html", "ones-project-api", "email_templates/task_update_email_html"),
        ("email_templates/wraps/task_wrap_html", "ones-project-api", "email_templates/wraps/task_wrap_html"),
