...
if __name__ == '__main__':
    ...
    module_mapping = {
        ...
        "app/services_refactor/task": ("project-api", "task"),
        "app/services_refactor/workflow_refactor": ("project-api", "task"),
        "app/core/test_case": ("", ""),
        "app/core/objectlink": ("project-api", "task"),
        "app/core/collector": ("project-api", "task"),
        "app/core/wiki": ("", ""),
        "app/core/utils": ("", ""),
        "app/core/user": ("", ""),
        "app/core/scope": ("project-api", "task"),
        "app/core/product": ("", ""),
        "app/core/project": ("", ""),
        "app/core/issuetype": ("project-api", "task"),
        "app/core/workflow": ("project-api", "task"),
        "app/core/task": ("project-api", "task"),
        "app/core/publish_version": ("project-api", "task"),
        "app/core/resource": ("", ""),
        "app/core/sprint": ("", ""),
        "app/utils/tree": ("", ""),
        ...
        "app/models/pipeline": ("", ""),
        "app/models/testcase": ("", ""),
        "app/models/taskrelation": ("project-api", "task"),
        "app/models/issue_type_scope_field_constraint": ("project-api", "task"),
        "app/models/authconfig": ("", ""),
        "app/models/noticerules": ("project-api", "task"),
        "app/models/menu.v2": ("", ""),
        "app/models/devops": ("", ""),
        "app/models/role": ("", ""),
        "app/models/importer": ("", ""),
        "app/models/commonmessage": ("", ""),
        "app/models/objectcount": ("project-api", "task"),
        "app/models/oauth": ("", ""),
        "app/models/usergroup": ("", ""),
        "app/models/license": ("", ""),
        "app/models/noticeconfig": ("project-api", "task"),
        "app/models/accountnotice": ("", ""),
        "app/models/copilot": ("", ""),
        "app/models/import_rule": ("", ""),
        "app/models/config": ("", ""),
        "app/models/auth": ("", ""),
        "app/models/notification": ("project-api", "task"),
        ...
        "app/services/stripe": ("", ""),
        "app/services/common/organization": ("", ""),
        "app/services/common/noticerule": ("", ""),
        "app/services/common/context": ("", ""),
        "app/services/common/auth": ("", ""),
        "app/services/common/activity": ("", ""),
        "app/services/common/objectlink": ("", ""),
        "app/services/common/template": ("", ""),
        "app/services/common/observer": ("", ""),
        "app/services/common/component": ("", ""),
        "app/services/common/utils": ("", ""),
        "app/services/common/user": ("", ""),
        "app/services/common/kmutex": ("", ""),
        "app/services/common/status": ("", ""),
        "app/services/common/app_platform": ("", ""),
        "app/services/common/field": ("", ""),
        "app/services/common/workorder": ("", ""),
        "app/services/common/gantt": ("", ""),
        "app/services/common/container": ("", ""),
        "app/services/common/issuetype": ("", ""),
        "app/services/common/batch": ("", ""),
        "app/services/common/objectlinktype": ("", ""),
        "app/services/common/task": ("", ""),
        "app/services/common/template_defaultconfig": ("", ""),
        "app/services/common/sample": ("", ""),
        "app/services/common/liststore": ("", ""),
        "app/services/common/stamp": ("", ""),
        "app/services/common/report": ("", ""),
        "app/services/common/automation": ("", ""),
        "app/services/common/filter": ("", ""),
        "app/services/common/errors": ("", ""),
        "app/services/common/license_manager": ("", ""),
        "app/services/common/sprint": ("", ""),
        "app/services/common/userdomain": ("", ""),
        "app/services/common/thirdparty": ("", ""),
        "app/services/common/email": ("", ""),
        "app/services/common/statdog": ("", ""),
    }
